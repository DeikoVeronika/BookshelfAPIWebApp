...
namespace BookshelfAPIWebApp.Controllers
{
    public class BookCategoriesController : Controller
    {
        ...
        {
            var bookshelfAPIContext = _context.BookCategories.Include(b => b.Book).Include(b => b.Category);
            return View(await bookshelfAPIContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,CategoryId")] BookCategory bookCategory)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Id", bookCategory.BookId);
